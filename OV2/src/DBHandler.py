...
def main():
    ...
    try:
        ...
        program.create_tables()
        print("----------\n")
        t = program.execute_insert("INSERT INTO user (id, has_labels) VALUES (%s, %s)", ('000', 0))
        t = program.execute_insert("INSERT INTO user (id, has_labels) VALUES (%s, %s)", ('001', 0))
        t2 = program.execute_insert("INSERT INTO activity (user_id, transportation_mode, start_date_time, end_date_time) VALUES (%s, %s, %s, %s)", ('000', None, "2007-06-26 11:40:29", "2007-06-26 11:47:29"))
        t3 = program.execute_insert("INSERT INTO activity (user_id, transportation_mode, start_date_time, end_date_time) VALUES (%s, %s, %s, %s)", ('001', None, "2007-06-26 11:40:29", "2007-06-26 11:47:29"))
        print(t2)
        print(t3)
        print("\n----------")
